/**
 * This controller defines the HTTP endpoints for the category feature.
 * It receives requests, reads route parameters or request bodies, and forwards the real work to the matching service.
 * It sits between incoming API calls and the category service layer, often combining guards, decorators, and Swagger documentation.
 */
import {
  Body,
  Controller,
...
/**
 * The CategoryController class handles HTTP requests for this feature.
