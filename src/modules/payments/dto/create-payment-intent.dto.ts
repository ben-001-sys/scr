 ...
 */
// Import IsNotEmpty, IsNumber, IsOptional, IsString from class-validator because it is needed in this file.
import { IsNotEmpty, IsNumber, IsOptional, IsString } from 'class-validator';

/**
 * The CreatePaymentIntentDto class describes a specific API data shape.
